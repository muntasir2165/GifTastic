var topics = ["avengers", "justice league"];
...
function generateGifButton() {}

function displayGifButton(gifButton) {}

function processUserGifInput() {}
...
function removeGifsFromDisplay() {}
